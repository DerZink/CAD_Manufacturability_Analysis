...
class Ui_PartPairForm(object):
    def setupUi(self, PartPairForm):
        ...
        sizePolicy1.setHeightForWidth(self.partPairs_tableView.sizePolicy().hasHeightForWidth())
        ...
        self.partPairs_tableView.setSizeAdjustPolicy(QAbstractScrollArea.AdjustToContents)
        ...
        self.pushButton_geometricSimilarity.setObjectName(u"pushButton_geometricSimilarity")
        ...
        sizePolicy4.setHeightForWidth(self.pushButton_featureSimilarity.sizePolicy().hasHeightForWidth())
        ...
        sizePolicy4.setHeightForWidth(self.pushButton_load.sizePolicy().hasHeightForWidth())
        ...
        self.gridLayout_4.addWidget(self.label_BodyA, 0, 0, 1, 1, Qt.AlignHCenter|Qt.AlignVCenter)
        ...
        self.gridLayout_5.addWidget(self.label_BodyB, 0, 0, 1, 1, Qt.AlignHCenter|Qt.AlignVCenter)
        ...
        sizePolicy6.setHeightForWidth(self.pairProperties_tableView.sizePolicy().hasHeightForWidth())
        ...
        self.pairProperties_tableView.horizontalHeader().setProperty("showSortIndicator", True)
        ...
        sizePolicy4.setHeightForWidth(self.pushButton_Overlay.sizePolicy().hasHeightForWidth())
        ...
        self.verticalLayout.addWidget(self.pushButton_Overlay, 0, Qt.AlignHCenter|Qt.AlignVCenter)
    ...
    def retranslateUi(self, PartPairForm):
        PartPairForm.setWindowTitle(QCoreApplication.translate("PartPairForm", u"Form", None))
        self.groupBox.setTitle(QCoreApplication.translate("PartPairForm", u"Preference Calculation ", None))
        self.pushButton_geometricSimilarity.setText(QCoreApplication.translate("PartPairForm", u"Geometric Similarity", None))
        self.pushButton_featureSimilarity.setText(QCoreApplication.translate("PartPairForm", u"Feature Similarity", None))
        self.groupBox_2.setTitle(QCoreApplication.translate("PartPairForm", u"Data Management", None))
        self.pushButton_positioning.setText(QCoreApplication.translate("PartPairForm", u"Positioning", None))
        self.pushButton_deleteAll.setText(QCoreApplication.translate("PartPairForm", u"Delete all", None))
        self.pushButton_load.setText(QCoreApplication.translate("PartPairForm", u"Load\n"
"Parts", None))
        self.pushButton_save.setText(QCoreApplication.translate("PartPairForm", u"Save", None))
        self.pushButton_reset.setText(QCoreApplication.translate("PartPairForm", u"Reset", None))
        self.groupBox_3.setTitle(QCoreApplication.translate("PartPairForm", u"Body A", None))
        self.label_BodyA.setText(QCoreApplication.translate("PartPairForm", u"TextLabel", None))
        self.groupBox_4.setTitle(QCoreApplication.translate("PartPairForm", u"Body B", None))
        self.label_BodyB.setText(QCoreApplication.translate("PartPairForm", u"TextLabel", None))
        self.pushButton_Overlay.setText(QCoreApplication.translate("PartPairForm", u"Build Overlay", None))
    # retranslateUi
